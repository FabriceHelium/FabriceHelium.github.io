...
import { computed } from 'vue'; // Supprimé 'ref' car il n'est pas utilisé
...
<template>
  <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
    <div class="flex justify-between items-center mb-4">
      <h3 class="text-lg font-semibold text-gray-900">Scène {{ scene.id }}</h3>
      <button
        @click="emit('delete')"
    ...
    <div class="mt-6">
      <div class="flex justify-between items-center mb-2">
        <h4 class="text-sm font-medium text-gray-700">Prompt Généré:</h4>
